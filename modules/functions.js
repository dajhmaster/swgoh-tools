module.exports = (client) => {
  ...
  */
  ...
  client.timeDiff = (startTime) => {
    const moment = require("moment");
    var startTime = moment(new Date(), "HH:mm:ss a");
    var endTime = moment(startTime, "HH:mm:ss a");
    var duration = moment.duration(endTime.diff(startTime));
    var hours = parseInt(duration.asHours());
    var minutes = parseInt(duration.asMinutes())-hours*60;
    var TDiff = moment.utc(moment(startTime,"DD/MM/YYYY HH:mm:ss").diff(moment(endTime,"HH:mm"))).format("HH:mm");
    return TDiff;
  }
